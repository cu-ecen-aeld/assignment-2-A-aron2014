...
void test_validate_my_username()
{
	...
	const char *str = my_username();
	char *defined_name = malloc_username_from_conf_file();

	TEST_ASSERT_EQUAL_STRING_MESSAGE(str,defined_name, "The username is incorrect. Please fix!" );
}
